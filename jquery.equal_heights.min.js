 ...
 *
 */(function(e){e.fn.equalHeights=function(t){var n=e.extend({filter:null,not:null,target:null,once:!0,reset:!1,disable:!1,responsive:!0,delay:25},t),r=0,i=e(this),s=i.children(),o=e();n.target&&(o=i.find(n.target));n.filter&&(s=s.filter(n.filter));n.not&&(s=s.not(n.not));n.once&&(s=s.not("equal-heights-processed"));if(s.length==1)return e(this);(n.reset||n.disable)&&s.add(o).height("");if(n.disable)return e(this);s.each(function(){var t=e(this),n=t.outerHeight();r=Math.max(r,n)});n.target&&(s=s.add(o));var u="equal-heights-processed";s.addClass(u).height(r);if(n.responsive){var a;e(window).bind("resize",function(e){a||(a=setTimeout(function(){n.reset=!0;return i.equalHeights(n)},n.delay))})}i.addClass(u);return e(this)};e.fn.equalHeights.version=function(){return"1.0.0"}})(jQuery);